        ...
        <div class="container">
          ...
          <div class="row mt-50">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="product">
                <div class="product-wrap"> <img height="400px" width="500px" src="{{ asset($product->photo) }}" class="img-responsive" alt="team-01">
  ...
  <section>
    <div class="container">
      <div class="row">
        <div class="col-sm-8 section-heading">
          <h2 class="text-uppercase">Top Selling</h2>
          <h4 class="text-uppercase source-font">- Most People Buy -</h4>
        </div>
      </div>
      <div class="row mt-50">
        <div class="col-md-12 remove-padding">
          <div class="owl-carousel blog-slider">
            @foreach ($products as $product)
            <div class="post">
              <div class="post-img"> <img class="img-responsive" src="{{ asset($product->photo) }}" alt=""/> </div>
              <div class="post-info">
                <h3><a href="{{ route('productDetail', $product->id) }}">{{ $product->name }}</a></h3>
                <h6>Rating</h6>
                <p>${{ $product->price - $product->price * $product->discount }} <span
                    class="old-price">${{ $product->price }}</span></p>
                <a class="readmore" href="{{ route('add.to.cart', $product->id) }}"><span>Add to cart</span></a> </div>
            </div>
            @endforeach
          </div>
        </div>
