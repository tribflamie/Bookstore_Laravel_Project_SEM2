...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            ...
            'price' => 15.00,
            'discount' => 0.15,
            'photo' => "Harry_Potter_and_the_Philosopher's_Stone_Book_Cover.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 23,
            'discount' => 0.12,
            'photo' => 'A-Tale-of-Two-Cities.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 33,
            'discount' => 0.30,
            'photo' => 'The-Catcher-in-the-Rye.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 27,
            'discount' => 0.25,
            'photo' => 'One-Hundred-Years-of-Solitude.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 29,
            'discount' => 0.22,
            'photo' => 'The Hunchback of Notre-Dame.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 33,
            'discount' => 0.29,
            'photo' => 'The-War-of-the-Jewels.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 19,
            'discount' => 0.50,
            'photo' => 'The-Priory-of-the-Orange-Tree.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 29,
            'discount' => 0.40,
            'photo' => 'The-Peoples-of-Middle-earth.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 29,
            'discount' => 0.35,
            'photo' => 'The-Future-of-the-Mind.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 35,
            'discount' => 0.30,
            'photo' => 'The-Fall-Of-Gondolin.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 45,
            'discount' => 0.25,
            'photo' => 'The-Hound-of-the-Baskervilles.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 57,
            'discount' => 0.20,
            'photo' => 'The-Heroes-of-Olympus.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 37,
            'discount' => 0.05,
            'photo' => 'The Count Of Monte Cristo.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 31,
            'discount' => 0.00,
            'photo' => 'Sense and Sensibility.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 51,
            'discount' => 0.1,
            'photo' => 'Incidents in the Life of a Slave Girl.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 50,
            'discount' => 0.10,
            'photo' => 'The Portrait of a Lady.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 54,
            'discount' => 0.10,
            'photo' => 'The Three Musketeers.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 36,
            'discount' => 0.10,
            'photo' => 'The War of the Worlds.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 37,
            'discount' => 0.10,
            'photo' => 'The Island of Doctor Moreau.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 57,
            'discount' => 0.10,
            'photo' => 'The Old Man and the Sea.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 32,
            'discount' => 0.10,
            'photo' => 'The Story of King Arthur and His Knights.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 29,
            'discount' => 0.10,
            'photo' => 'Around the World in Eighty Days.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 35,
            'discount' => 0.10,
            'photo' => "The Pilgrim's Progress.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 34,
            'discount' => 0.10,
            'photo' => 'A Spy in the House of Love.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 65,
            'discount' => 0.10,
            'photo' => 'The Turn of the Screw.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 67,
            'discount' => 0.10,
            'photo' => 'From the Earth to the Moon.jpg',
        ...
        DB::table('products')->insert([
            ...
            'price' => 59,
            'discount' => 0.10,
            'photo' => "The Mirror Crack'd from Side to Side.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 48,
            'discount' => 0.10,
            'photo' => "The Return of Sherlock Holmes.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 53,
            'discount' => 0.10,
            'photo' => "The Phantom of the Opera.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 51,
            'discount' => 0.10,
            'photo' => "The Old Curiosity Shop.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 47,
            'discount' => 0.10,
            'photo' => "The Wonderful Wizard of Oz.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 54,
            'discount' => 0.10,
            'photo' => "A Midsummer Night's Dream.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 40,
            'discount' => 0.10,
            'photo' => "The Tenant of Wildfell Hall.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 65,
            'discount' => 0.10,
            'photo' => "Boy In The Striped Pajamas.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 66,
            'discount' => 0.10,
            'photo' => "Alice's Adventures in Wonderland.jpg",
            'description' => "The Mirror Crack'd from Side to Side, a novel by Agatha Christie, was published in the UK in 1962 and a year later in the US under the title The Mirror Crack'd. The story features amateur detective Miss Marple solving a mystery in St. Mary Mead.
        ...
        DB::table('products')->insert([
            ...
            'price' => 39,
            'discount' => 0.10,
            'photo' => "The Mill on the Floss.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 27,
            'discount' => 0.20,
            'photo' => "The Last Of The Mohicans.jpg",
        ...
        DB::table('products')->insert([
            ...
            'price' => 39,
            'discount' => 0.15,
            'photo' => "The Mayor of Casterbridge.jpg",
